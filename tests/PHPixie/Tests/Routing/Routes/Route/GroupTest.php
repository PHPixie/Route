...
/**
 * @coversDefaultClass \PHPixie\Routing\Routes\Route\Group
 */
class GroupTest extends \PHPixie\Test\Testcase
{
    ...
    public function setUp()
    {
        ...
        $this->group = new \PHPixie\Routing\Routes\Route\Group(
            $this->routeBuilder,
            $this->configData
        );
    }
    ...
    {
        $this->prepareRouteNames();
        $this->setExpectedException('\PHPixie\Routing\Exception\Route');
    ...
    {
        return $this->quickMock('\PHPixie\Routing\Translator\Fragment');
    }
    
    protected function getMatch()
    {
        return $this->quickMock('\PHPixie\Routing\Translator\Match');
    }
}