...
namespace PHPixie\Tests\Routing\Routes\Route\Pattern;

/**
 * @coversDefaultClass \PHPixie\Routing\Routes\Route\Pattern\Prefix
 */
class PrefixTest extends \PHPixie\Tests\Routing\Routes\Route\PatternTest
{
    protected $routeBuilder;
    
    public function setUp()
    {
        $this->routeBuilder = $this->quickMock('\PHPixie\Routing\Routes\Builder');
        parent::setUp();
    }
    ...
    {
        return $this->quickMock('\PHPixie\Routing\Routes\Route');
    }
        
    protected function route()
    {
        return new \PHPixie\Routing\Routes\Route\Pattern\Prefix(
            $this->builder,
            $this->routeBuilder,
            $this->configData
        );
    ...
    {
        return $this->getMock(
            '\PHPixie\Routing\Routes\Route\Pattern\Prefix',
            $methods,
            array(
                $this->builder,
                $this->routeBuilder,
