...
/**
 * @coversDefaultClass \PHPixie\Routing\Routes\Route\Pattern
 */
abstract class PatternTest extends \PHPixie\Test\Testcase
{
    ...
    public function setUp()
    {
        ...
        $this->matcher = $this->quickMock('\PHPixie\Routing\Matcher');
    }
    ...
    {
        return $this->quickMock('\PHPixie\Routing\Matcher\Pattern');
    }
