...
namespace PHPixie\Tests\Routing\Routes\Registry;

/**
 * @coversDefaultClass \PHPixie\Routing\Routes\Registry\Config
 */
class ConfigTest extends \PHPixie\Test\Testcase
{
    ...
    public function setUp()
    {
        ...
        $this->config = new \PHPixie\Routing\Routes\Registry\Config(
            $this->routeBuilder,
            $this->configData
        );
    }
    ...
    public function testGet()
    {
        ...
        $locator = $this->quickMock('\PHPixie\Routing\Routes\Locator');
