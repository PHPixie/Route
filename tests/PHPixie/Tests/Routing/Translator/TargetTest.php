...
namespace PHPixie\Tests\Routing\Translator;

/**
 * @coversDefaultClass \PHPixie\Routing\Translator\Target
 */
class TargetTest extends \PHPixie\Test\Testcase
{
    ...
    {
        $this->translator = $this->quickMock('\PHPixie\Routing\Translator');
        
        $this->target  = new \PHPixie\Routing\Translator\Target(
            $this->translator,
            $this->routePath
        );
    }
