...
/**
 * @coversDefaultClass \PHPixie\Routing\Translator
 */
class TranslatorTest extends \PHPixie\Test\Testcase
{
    ...
    {
        $configData = $this->prepareConfigData();
        $translator = new \PHPixie\Routing\Translator(
            $this->builder,
            $this->route,
            $configData
        );
